...
import CatalogButton from "./header-catalog/ui/CatalogButton/CatalogButton";
  ...
  return (
    <div className="container">
      <div className={styles.header_panel_main}>
        ...
        <div className={styles.header_panel_features}>
          ...
          <div className={styles.header_mobile_favorites_main}>
            ...
            <div className={styles.mobile_input_search}>
              <button onClick={() => togglePanel("search")}>
                ...
                <span className={styles.span_input_search}>
                  Поиск
                </span>
